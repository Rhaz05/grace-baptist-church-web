    ...
    <footer className="bg-church-dark border-t-4 border-church-red text-gray-300 text-sm relative z-20">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="mb-6">
              <h4 className="font-bold text-white uppercase text-lg">Grace Baptist Church</h4>
              <div className="w-16 h-1 bg-church-red mt-3"></div>
            </div>
            <p className="mb-6 text-gray-400 leading-relaxed">
              We are a community committed to sharing the love of Jesus Christ. Join us as we grow
              in faith and serve our city together.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Citta Grande 3 Grace Baptist Church, Lot 1, Blk.41 Quezon, Ibabang Iyam Lucena
                  City
                </span>
              </li>
...
const FooterLink = ({ to, label }) => (
  <li>
    ...
    >
      <FaChevronRight className="text-[10px] mr-2 opacity-50" /> {label}
    </Link>
  </li>
)
