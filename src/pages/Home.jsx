...
import { FaPlay, FaRegClock, FaInfoCircle } from 'react-icons/fa'
    ...
    <div className="flex flex-col gap-12 pb-20 overflow-hidden">
      ...
      <section className="max-w-5xl mx-auto mb-28">
        ...
        >
          ...
          >
            <ScheduleItem time="9:00 AM" title="Sunday School" desc="Bible study for all ages" />
            <ScheduleItem time="10:00 AM" title="Morning Worship" desc="Main Service & Preaching" />
            <ScheduleItem
              time="4:00 PM"
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
          ...
          <motion.div
            ...
            className="bg-white rounded-b-3xl rounded-tr-3xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100 border border-gray-50"
          >
            <ScheduleItem time="5:30 PM" title="Prayer Meeting" desc="Midweek Devotion & Prayer" />
...
const ScheduleItem = ({ time, title, desc }) => (
  ...
  >
    <div className="flex items-center gap-3 mb-3">
      ...
      <span className="font-black text-zinc-900 text-2xl tracking-tighter">{time}</span>
    </div>
